			...
			<Table>
				<TableHeader className="sticky top-0 z-10 bg-background border-b">
					<TableRow className="hover:bg-transparent">
						<TableHead className="text-xs font-semibold text-muted-foreground whitespace-nowrap py-2.5 pl-3 w-[70px]">
							Date
						</TableHead>
						<TableHead className="text-xs font-semibold text-muted-foreground py-2.5 px-2 w-[30%]">
							Craft
						</TableHead>
						<TableHead className="text-xs font-semibold text-muted-foreground py-2.5 px-2 w-[30%]">
							Market
						</TableHead>
						<TableHead className="text-xs font-semibold text-muted-foreground py-2.5 pr-3 pl-2 w-[30%]">
							Profit
						</TableHead>
					</TableRow>
				</TableHeader>
