  ...
  return (
      <>
        <nav className="flex justify-center relative z-50">
          <div
              className="bg-black rounded-full flex items-center pointer-events-auto border border-zinc-800 px-4 py-4 md:px-10 md:py-4 md:gap-12">
          ...
          >
            <div
                className="bg-black/90 backdrop-blur-xl rounded-2xl border border-zinc-800 shadow-xl overflow-hidden">
