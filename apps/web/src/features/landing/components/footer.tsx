  ...
  return (
      <footer className="w-full bg-black pt-20 pb-10 border-t border-white/5 relative z-20">
        <div className="max-w-6xl mx-auto px-4 flex flex-col items-center text-center">
          <div className="mb-12">
            <div
                className="p-4 bg-zinc-900/20 rounded-full border border-zinc-800/50 hover:border-zinc-700/50 transition-all duration-500 hover:scale-105">
          ...
          <div
              className="space-y-3 text-xs leading-relaxed text-zinc-700 max-w-xl mx-auto border-t border-zinc-700/50 pt-8">
            <p>
