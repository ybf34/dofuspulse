...
const MetricRow = ({ label, value }: { label: string; value: number }) => (
	<div className="flex items-center justify-between py-4 border-b border-zinc-100 dark:border-zinc-800/60 last:border-0">
		...
		<div className="flex items-center gap-4">
			<span className="text-2xl font-bold tabular-nums text-zinc-900 dark:text-white tracking-tight">
				{formatNumber(value)}
			</span>
...
const NoDataCard = ({ item }: { item: ItemWithQuantity }) => (
	<div className="flex flex-col items-center justify-center h-full min-h-[140px] p-4 rounded-lg border border-dashed border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/10">
		<div className="relative mb-3">
			...
			/>
			<div className="absolute -right-1 -bottom-1 bg-zinc-100 dark:bg-zinc-800 rounded-full p-0.5 border border-zinc-200 dark:border-zinc-700">
...
const DashboardEmptyState = () => (
	<div className="flex flex-col items-center justify-center h-[400px] border border-dashed border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50/50 dark:bg-zinc-900/20">
		<EmptyHeader>
			<div className="flex items-center justify-center mb-4">
				<div className="p-4 rounded-full bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-200 dark:ring-zinc-800">
			...
			<EmptyDescription className="text-zinc-500 dark:text-zinc-400 max-w-xs text-center mx-auto mt-2 text-sm">
...
export function GearsetPriceDialog({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-w-[95vw] w-full sm:max-w-6xl h-[90vh] flex flex-col p-0 gap-0 bg-background border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-hidden">
				<DialogHeader className="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/20 flex-shrink-0">
					<div className="flex flex-col gap-1.5">
						...
						<div className="flex items-center justify-between">
							<DialogTitle className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white flex items-center gap-3">
								{gearset.title}
								<Badge
									variant="outline"
						...
						<div className="p-6 md:p-8 space-y-10">
							<div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
								...
								<div className="lg:col-span-8 xl:col-span-9">
									<div className="h-full border border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50/50 dark:bg-zinc-900/10 p-6">
