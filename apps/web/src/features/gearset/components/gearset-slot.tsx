...
export default function GearsetSlot({
  ...
  return (
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            {!equippedItem && !isPreview && (
                <div
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 rounded-md transition-all duration-200 flex items-center justify-center bg-gradient-to-br from-neutral-700/80 to-neutral-800/80 backdrop-blur-sm">
                  <Plus
        ...
        {equippedItem && (
            <PopoverContent
                className="p-3 w-76 rounded-lg shadow-2xl border border-border bg-card text-card-foreground text-sm dark:border-primary/20">
              ...
              <div
                  className="flex justify-between items-center mt-1.5 text-xs pb-2 border-b border-border dark:border-primary/20">
