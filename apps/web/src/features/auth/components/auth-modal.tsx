	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-md bg-black border-zinc-800 text-white">
				...
				>
					<TabsList className="grid w-full grid-cols-2 bg-zinc-900/50 border border-zinc-800 p-1 rounded-full">
						<TabsTrigger
							value="login"
					...
					<TabsContent value="login" className="mt-6">
						<div className="grid gap-4">
							...
							<div className="after:border-zinc-800 relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
