...
import ItemFilters, {type ItemFilterConfig,} from "@/features/items/components/item-filters";
  ...
  return (
      <div className="flex flex-1 h-full">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <Separator/>
          <div
              className="flex px-6 py-3 items-center justify-center border-t border-border bg-background">
            <Pagination>
