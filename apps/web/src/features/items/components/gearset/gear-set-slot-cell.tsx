      ...
      <Popover>
        <Tooltip>
          <PopoverTrigger asChild>
            <TooltipTrigger asChild>
              {itemDetails ? (
                  ...
                  >
                    <div
                        className="w-full h-full opacity-0 group-hover:opacity-100 rounded-md transition-all duration-200 flex items-center justify-center bg-neutral-700">
                      <Plus
          ...
          {itemDetails && (
              ...
              >
                <div
                    className="flex justify-between items-start gap-1 pb-1 border-b border-primary/20 mb-1">
