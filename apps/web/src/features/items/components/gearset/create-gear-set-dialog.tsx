...
export default function CreateGearsetDialog() {
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="w-full max-w-md border bg-card dark:bg-zinc-950 text-card-foreground dark:text-white p-4">
				<DialogHeader className="pb-3">
					<div className="flex items-center gap-2">
						...
						<div>
							...
							<DialogDescription className="text-xs text-muted-foreground dark:text-gray-400 mt-0.5">
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem className="space-y-2">
									<FormLabel className="text-sm font-medium text-foreground dark:text-white flex items-center gap-2">
										Gearset Name
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem className="space-y-2">
									<FormLabel className="text-sm font-medium text-foreground dark:text-white flex items-center gap-2">
										Tags
										<span className="text-xs text-muted-foreground dark:text-gray-400 font-normal"></span>
									</FormLabel>
									<div className="p-3 rounded-lg border dark:border-zinc-700 bg-muted/50 dark:bg-zinc-950/50">
										<TagSelector
											value={field.value ?? []}
