			...
			<SidebarHeader className="pt-8 pb-10 px-6">
				...
				>
					...
					<div className="flex items-baseline gap-1.5">
						<span className="text-lg font-semibold dark:font-light tracking-tight text-zinc-950 dark:text-white transition-all">
							DOFUS
						</span>
						<span className="text-lg font-medium dark:font-light tracking-widest text-zinc-950 dark:text-white transition-all">
							PULSE
						</span>
					</div>
				</Link>
