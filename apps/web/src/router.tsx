	...
	component: () => (
		<AuthenticatedLayout>
			<SidebarProvider className="h-screen w-full overflow-hidden">
				<AppSidebar />
				<div className="flex-1 flex flex-col min-w-0 h-screen pl-0 sm:pr-2 sm:pt-2 bg-slate-50 dark:bg-background">
					<div className="flex flex-col flex-1 bg-background overflow-hidden border-zinc-200 sm:border-t sm:border-x sm:dark:border-x-2 sm:dark:border-t-2 dark:border-zinc-900 sm:rounded-t-xl">
						{" "}
						<Navbar />
